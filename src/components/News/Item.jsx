...
const Item = ({ link, title, content, image }) => {
  return (
    <Stack direction={{ base: "column", md: "row" }} justifyContent="left" my={5}>
      <Box mr={{ base: 0, md: 5 }} pos="relative">
        <Image boxShadow="lg" w="100%" h="100%" minW={{ base: "auto", md: "30rem" }} maxH="20rem" objectFit="cover" src={image.large} rounded="md" fallback={<Skeleton />} />
      </Box>
